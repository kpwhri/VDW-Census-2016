...
/*B01001 - SEX BY AGE*/
		...
		&_siteabbr._ACS_male18overpop=sum(B01001007,B01001008,B01001009,B01001010,B01001011,B01001012,B01001013,B01001014,B01001015,B01001016,B01001017,B01001018,B01001019,
						B01001020,B01001021,B01001022,B01001023,B01001024,B01001025);
		&_siteabbr._ACS_female18overpop=sum(B01001031,B01001032,B01001033,B01001034,B01001035,B01001036,B01001037,
        ...
        &_siteabbr._ACS_18overpop=sum(B01001007,B01001008,B01001009,B01001010,B01001011,B01001012,B01001013,B01001014,B01001015,B01001016,B01001017,B01001018,B01001019,
						...
						B01001038,B01001039,B01001040,B01001041,B01001042,B01001043,B01001044,B01001045,B01001046,B01001047,B01001048,B01001049);
		&_siteabbr._ACS_male25overpop=sum(B01001011,B01001012,B01001013,B01001014,B01001015,B01001016,B01001017,B01001018,B01001019,
						B01001020,B01001021,B01001022,B01001023,B01001024,B01001025);
		&_siteabbr._ACS_female25overpop=sum(B01001035,B01001036,B01001037,
						B01001038,B01001039,B01001040,B01001041,B01001042,B01001043,B01001044,B01001045,B01001046,B01001047,B01001048,B01001049);
...
data _output.census_demog_&ACS_YEAR. 
(drop=KPCO_ACS_HOUSES_N rename=(KPCO_ACS_HOUSES_N2=KPCO_ACS_HOUSES_N)); 
...
/* Clean up the working directories and files 
%LET codehome = \\HOME\mackcd1\Documents\VDW\Census\Production;
%LET temp_dir = &CODEHOME.\temp;
options noxwait xsync;
libname output "&CODEHOME.\output";
%MACRO maybe_delete(lib);
	%IF %SYSFUNC(exist(output.census_location)) and
		%SYSFUNC(exist(output.census_demog)) %THEN %DO;
		x "del /Q &TEMP_DIR.\*.*";
		x "rmdir /S /Q &TEMP_DIR.\acs_geo_output";
		x "rmdir /S /Q &TEMP_DIR.\acs_seg_output";
	%END;
	%ELSE %DO;
		%IF %SYSFUNC(exist(output.census_location)) = 0 %THEN %DO;
			%PUT ;
			%PUT WARNING: File "output.census_location" could not be found.;
			%PUT ;
		%END;
		%IF %SYSFUNC(exist(output.census_demog)) = 0 %THEN %DO;
			%PUT ;
